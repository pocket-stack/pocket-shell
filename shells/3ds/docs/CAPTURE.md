...
bun run shot --host 192.168.1.20 --out shells/3ds/media/hw/tiled.png
```
...
```sh
bun run omarchy shots media    # every screen as a PNG
bun run omarchy films media    # every animation as a GIF
```
