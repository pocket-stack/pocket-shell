...
// src/wall/prepare.ts — cook the Omarchy tokyo-night backgrounds
// into pak-ready textures.
//
//   bun shells/3ds/src/wall/prepare.ts <source-dir>
//
...
if (!sourceDir) {
  console.error("usage: bun shells/3ds/src/wall/prepare.ts <dir with the tokyo-night backgrounds>");
  process.exit(1);
}
