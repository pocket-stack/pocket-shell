...
// ipod/menu-sheet.tsx — Omarchy's menu (SUPER + SPACE) as a
...
import { APPS_ROUTE, type CompanionStore, type SheetRow } from "./store.ts";
...
function Row(p: { store: CompanionStore; row: SheetRow; i: number }) {
...
export function MenuSheet(p: { store: CompanionStore }) {
...
export function sheetHandlers(store: CompanionStore): GestureHandlers {
