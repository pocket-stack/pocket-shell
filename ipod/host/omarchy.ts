...
// ipod/host/omarchy.ts — the Omarchy side of the daemon: run
...
export class Pointer {
  ...
  private start(): void {
    ...
    if (!this.available()) {
      if (!this.failedAt) this.log(`pointer: ${this.binary} is missing — redeploy with scripts/omarchy.ts deploy-host`);
