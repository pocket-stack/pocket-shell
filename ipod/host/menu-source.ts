...
// ipod/host/menu-source.ts — Omarchy's menu definition, read
...
// evaluates the conditions, and `bun scripts/omarchy.ts menu`, which
// bakes the tree into the device as ipod/menu.ts. Pure: no
