...
// ipod/strip.tsx — the top strip: the workspace tabs (a FIXED
...
export function Strip(p: { store: CompanionStore }) {
...
function stripTarget(store: CompanionStore, x: number, y: number): Target {
...
export function stripHandlers(store: CompanionStore): GestureHandlers {
