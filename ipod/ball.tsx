...
// ipod/ball.tsx — the menu's handle: a translucent ball that
...
export function Ball(p: { store: CompanionStore }) {
...
export function ballHandlers(store: CompanionStore): GestureHandlers {
  return {
