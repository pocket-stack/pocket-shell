...
// ipod/control.tsx — the control centre: a card under its
...
function Slider(p: { store: CompanionStore; row: 0 | 1 }) {
...
export function ControlCentre(p: { store: CompanionStore }) {
...
export function ccHandlers(store: CompanionStore): GestureHandlers {
